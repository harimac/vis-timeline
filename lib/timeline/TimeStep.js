  ...
  getClassName() {
    ...
    switch (this.scale) {
      case 'millisecond':
        ...
        break;
      case 'second':
        classNames.push("vis-".concat(current.format('dddd').toLowerCase())); // [XAM] Enable Saturday/Sunday on second sacel
        classNames.push(today(current));
        classNames.push(even(current.seconds()));
        break;
      case 'minute':
        classNames.push("vis-".concat(current.format('dddd').toLowerCase())); // [XAM] Enable Saturday/Sunday on minute sacel
        classNames.push(today(current));
        classNames.push(even(current.minutes()));
        break;
      case 'hour':
        classNames.push("vis-".concat(current.format('dddd').toLowerCase())); // [XAM] Enable Saturday/Sunday on hour sacel
    ...
    // [XAM]-S Support holiday
    if (typeof(this.format.customClassName) === "function") {
      this.format.customClassName(current, this.scale, this.step, classNames);
    }
    // [XAM]-E Support holiday
