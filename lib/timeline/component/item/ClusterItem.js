 ...
 */
  ...
  repositionStype(start, end) {
    ...
    if (end) {
      ...
      if (lineOffsetDirection) {
        this.dom.line.style.left = `${lineOffsetDirection}px`;
      }
      else {
        this.dom.line.style.left = null;
      }
      if (dotOffsetDirection) {
        this.dom.dot.style.left = `${dotOffsetDirection}px`;
      }
      else {
        this.dom.dot.style.left = null;
      }
      // [XAM]-E
    } else {
