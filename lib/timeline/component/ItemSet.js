 ...
 */
  ...
  _onGroupDragStart(event) {
    ...
    if (this.options.groupEditable.order) {
      ...
      // [XAM] Enableing grouEditable on each group level
      if (this.groupTouchParams.group && this.groupTouchParams.group.groupEditable.order) {
        event.stopPropagation();      
  ...
  _onGroupDrag(event) {
      // [XAM] Enableing grouEditable on each group level
      if (this.options.groupEditable.order && this.groupTouchParams.group && this.groupTouchParams.group.groupEditable.order) {
          event.stopPropagation();
